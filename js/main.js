...
const eleID_divExp = document.getElementById("divExp");
...
const eleID_btnGestExp= document.getElementById("btnGestExp");
...
function eliminaClass(elementRebut, nomClass) {
    ...
    function mostraGestioMalaties(objecte){
      document.getElementById('divMalalties').onclick = function tanca() {
            eleID_divPresentacio.classList.toggle("d-none");
   ...
   function mostraGestioExp(objecte){
     document.getElementById('tancadivExp').onclick = function tanca() {
           eleID_divPresentacio.classList.toggle("d-none");
           eleID_divExp.classList.toggle("d-none");
           mostraBotons();
     }
     eleID_divPresentacio.classList.toggle("d-none");
     eleID_divExp.classList.toggle("d-none");
